...
#+begin_src python :tangle data/generate_data_np_uv.py :results none
# /// script
...
libraries that are not Python packages—things like =LAMMPS=, =GROMACS=, or *eOn*
...
-  [[http://rgpycrumbs.rgoswami.me/][*rgpycrumbs*]] :: For helper utilities.
