...
[Pandoc-flavored Markdown](https://pandoc.org/MANUAL.html) for static
files and \[r-markdown\] for dynamic files that can render code into
output. Please refer to the [Introduction to The Carpentries
...
valid Carpentries lesson:

1.  `questions`{.verbatim} are displayed at the beginning of the episode
    to prime the learner for the content.
2.  `objectives`{.verbatim} are the learning objectives for an episode
    displayed with the questions.
3.  `keypoints`{.verbatim} are displayed at the end of the episode to
...
[You belong in The Carpentries!{alt='Blue Carpentries hex person logo
with no
...
::: keypoints
-   Use `.md`{.verbatim} files for episodes when you want static content
-   Use `.Rmd`{.verbatim} files for episodes when you need to generate
    output
-   Run `sandpaper::check_lesson()`{.verbatim} to identify any issues
    with your lesson
-   Run `sandpaper::build_lesson()`{.verbatim} to preview your lesson
    locally
:::
