...
#+BEGIN_SRC dot :file ../../episodes/fig/python-import-search-path.png :cmdline -Kdot -Tpng -Gdpi=200 :cache yes :exports none
digraph ImportLogic {
    rankdir=TD;
...
#+BEGIN_SRC dot :file ../../episodes/fig/python-package-structure.png :cmdline -Kdot -Tpng -Gdpi=200 :cache yes :exports none
digraph PackageTree {
    rankdir=TB;
